...
async function main() {
    ...
    console.log("-----------------------------");
    marsheet(subjectMarks.engMarks, subjectMarks.mathsMarks, subjectMarks.chemistryMarks, subjectMarks.physicsMarks, subjectMarks.computerMarks, totalMarks // Passing the total marks to the marsheet function
    );
}
function marsheet(eng, maths, chemistry, physics, computer, totalMarks) {
    let totalNumbers = eng + maths + chemistry + physics + computer;
    let percentage = (totalNumbers / 500) * 100;
    console.log("-----------------------------");
